-- ============================================================
-- Migration 115: ARK Courses Feature Flag
-- Created: 2026-03-20
-- Purpose: Add ark_courses_enabled to church_branding_settings
--          so ARK courses can be gated to specific churches.
...
ALTER TABLE church_branding_settings
  ADD COLUMN IF NOT EXISTS ark_courses_enabled BOOLEAN DEFAULT false;


-- ============================================================
-- Update branding RPC to include ark_courses_enabled
-- ============================================================
