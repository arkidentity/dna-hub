  ...
  return (
    <div className="card">
      <div className="flex items-center justify-between mb-4">
        ...
        <span className={`font-bold text-gold ${compact ? 'text-2xl' : 'text-3xl'}`}>{overallProgress}%</span>
      </div>
      <div className={`bg-background-secondary rounded-full overflow-hidden mb-4 ${compact ? 'h-3' : 'h-4'}`}>
        <div
