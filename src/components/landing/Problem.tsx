...
export default function Problem() {
  return (
    ...
    >
      {/* Full-bleed photo fading into dark section */}
      <div style={{ position: 'relative', width: '100%', height: 'clamp(220px, 40vw, 420px)' }}>
        <Image
          src="/dna-moment.jpg"
          alt="Pastor looking out a window, reflecting on multiplication"
          fill
        ...
        <div style={{
          position: 'absolute',
          inset: 0,
          background: 'linear-gradient(to bottom, rgba(26,35,50,0) 50%, var(--lp-ink) 100%)',
        }} />
      </div>
