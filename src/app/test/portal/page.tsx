...
const mockScenarios: Record<string, PortalData> = {
  pending_assessment: {
    church: {
      id: 'test-1',
    ...
    leader: {
      ...
      email: 'mike@newhope.org',
    },
    assessment: {
      id: 'a1',
      contact_name: 'Pastor Mike Davis',
      contact_email: 'mike@newhope.org',
      church_name: 'New Hope Church',
      submitted_at: '2024-03-01',
      congregation_size: '200-500',
      why_interested: 'We want to develop a stronger discipleship culture in our church and see multiplication happen naturally.',
  ...
  awaiting_discovery: {
    ...
    leader: {
      ...
      email: 'sarah@faithcommunity.org',
    },
    assessment: {
      id: 'a2',
      contact_name: 'Pastor Sarah Johnson',
      contact_email: 'sarah@faithcommunity.org',
      church_name: 'Faith Community Church',
      submitted_at: '2024-02-15',
      congregation_size: '100-200',
      why_interested: 'Looking to strengthen our small group ministry with intentional discipleship.',
      pastor_commitment_level: 'very_committed',
      desired_launch_timeline: '6-12 months',
    },
    documents: [
      {
        id: 'd1',
        document_type: '3_steps_pdf',
        file_url: 'https://example.com/3-steps.pdf',
        created_at: '2024-02-15',
      },
    ],
    nextCall: null,
  ...
  awaiting_strategy: {
    ...
    leader: {
      ...
      email: 'john@gracebaptist.org',
    },
    assessment: {
      id: 'a3',
      contact_name: 'Pastor John Smith',
      contact_email: 'john@gracebaptist.org',
      church_name: 'Grace Baptist Church',
      submitted_at: '2024-01-20',
      congregation_size: '500+',
      why_interested: 'Ready to transform our church culture around multiplication and discipleship.',
      pastor_commitment_level: 'fully_committed',
      desired_launch_timeline: 'ASAP',
    },
    documents: [
      {
        id: 'd1',
      ...
      },
      {
        ...
        notes: 'Great call! Pastor John has a clear vision for discipleship. The church has been doing small groups but wants more intentional multiplication. Looking at the Growth Tier.',
        created_at: '2024-02-01',
      },
      {
        id: 'd4',
    ...
    completedCalls: [
      {
        ...
        notes: 'Great discovery call. Moving forward with proposal.',
      },
      {
        id: 'c2',
        call_type: 'proposal',
        scheduled_at: '2024-02-20',
        notes: 'Chose Growth Tier. Agreement signed.',
      },
    ],
  },
};
...
export default function TestPortalPage() {
  const [selectedScenario, setSelectedScenario] = useState<string>('awaiting_discovery');
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="bg-navy text-white py-4 px-6">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-gold font-medium text-sm tracking-wide">DNA PARTNERSHIP (TEST)</p>
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        {/* Test Mode Banner with Scenario Selector */}
        <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 mb-6">
          <p className="text-sm text-navy mb-3">
            <strong>Test Mode:</strong> Select a scenario to preview different portal states.
          </p>
          <div className="flex flex-wrap gap-2">
            <button
              onClick={() => setSelectedScenario('pending_assessment')}
              className={`text-xs px-3 py-1.5 rounded-full transition-colors ${
                selectedScenario === 'pending_assessment'
                  ? 'bg-gold text-white'
            ...
            <button
              onClick={() => setSelectedScenario('awaiting_discovery')}
              className={`text-xs px-3 py-1.5 rounded-full transition-colors ${
                selectedScenario === 'awaiting_discovery'
                  ? 'bg-teal text-white'
                  : 'bg-white border border-teal/30 text-navy hover:bg-teal/10'
              }`}
            >
              Awaiting Discovery
            </button>
            <button
              onClick={() => setSelectedScenario('awaiting_strategy')}
              className={`text-xs px-3 py-1.5 rounded-full transition-colors ${
                selectedScenario === 'awaiting_strategy'
                  ? 'bg-success text-white'
                  : 'bg-white border border-success/30 text-navy hover:bg-success/10'
              }`}
            >
              Awaiting Strategy
            </button>
