...
const emailTemplates: EmailTemplate[] = [
  ...
  },
  {
    ...
    trigger: 'Church leader books a Discovery Call on /assessment/book-call — fires on page load',
    recipient: 'user',
    ...
    html: `
      <div style="font-family: system-ui, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p style="color: #5A6577; font-size: 14px;">
          Your login link is valid for 7 days. After that, visit <a href="https://dnadiscipleship.com/login" style="color: #2D6A6A;">dnadiscipleship.com/login</a> to request a new one.
        </p>
        <p style="margin-top: 32px;">Travis<br>
        <span style="color: #5A6577;">DNA Discipleship</span></p>
        <p style="color: #5A6577; font-size: 14px; margin-top: 24px;">
